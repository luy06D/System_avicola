...
(8,6,0,0,0.00,'2023-08-23',''),
(9,7,5,40,1.00,'2023-08-17','nada que decir'),
(10,2,8,40,5.00,'2023-08-23','........................'),
(11,2,2,2,2.00,'2023-08-24','no se me ocurre nada'),
(12,8,11,5,5.00,'2023-08-24','nada'),
(13,2,2,2,2.00,'2023-08-16','no se me ocurre nada'),
(14,3,2,2,2.00,'2023-08-04','abofbioabobaiod'),
(15,4,21,2,3000.00,'2023-09-01','Prueba'),
(16,6,4,3,3000.00,'2023-09-01','Prueba2'),
(17,9,4,3,2000.00,'2023-09-01','prueba x'),
(18,17,5,2,3000.00,'2023-09-01',''),
(19,2,4,3,0.00,'2023-09-01',''),
(20,2,6,4,2000.00,'2023-09-01',''),
(21,2,4,4,0.00,'2023-09-01',''),
(22,2,4,0,0.00,'2023-09-01',''),
(23,1,3,0,0.00,'2023-09-01',''),
(24,1,3,0,0.00,'2023-09-01',''),
(25,1,3,0,0.00,'2023-09-01',''),
(26,2,5,0,0.00,'2023-09-01',''),
(27,1,1,0,0.00,'2023-09-01','');
...
(1,1,1,400.00,NULL,NULL,'2023-09-01'),
(2,1,4,100.00,NULL,NULL,'2023-09-01'),
(3,1,2,100.00,NULL,NULL,'2023-09-01');
...
(1,'SOYA','KG',792,'Proteica, vegetal, versátil, nutricional','1'),
(2,'AFRECHO','KG',150,'Fibroso, salvado, integral, nutritivo.','1'),
(3,'MAIZ','KG',5198,'Cereal, amarillo, versátil, nutritivo.','1'),
(4,'SAL','KG',4955,'Mineral, condimento, saborizante, conservante','1'),
(5,'ACHOTE','KG',6150,'','1'),
(6,'METHIONINE','KG',4150,'','1'),
(7,'COLINA','KG',7000,'','1'),
(8,'PREMEZCLA','KG',11250,'','1'),
(9,'CARBONATO POLVO','KG',4150,'','1'),
...
(7,2,'2023-08-30','BANBIF',3,380.00,''),
(9,2,'2023-08-30','PLIN',4,4.00,''),
(10,5,'2023-09-01','BCP',1234,200.00,''),
(12,5,'2023-09-01','BCP',2134,400.00,''),
(13,5,'2023-09-01','BCP',1544,860.50,'');
...
(3,'adm','adm','','','1'),
(4,'Gonzalo ','Aguirre','64654654','989884984','1'),
(5,'Alex','Quiroz','72680725','959282307','1'),
(7,'Gabriel','Garcia','69176544','946464464','1'),
(8,'Luis David','Cusi Gonzales','73196921','934651825','1'),
(9,'JEAN','mateo','11351341','924562452','1');
...
(2,'Huevos Rosados','','1'),
(3,'Huevos Jumbo','','1'),
(4,'Huevos blanco','nada que decir','0'),
(5,'Huevos NEGROS','','0');
...
(3,4,'Gonzalo','$2y$10$N2aFv1EX13D/0vSkd3pOFuocaqVmsMDeTlV3R9L5L03gk.S2EO6vm','1'),
(4,7,'Gabriel','$2y$10$YBo95RQF8jA/KqifIq2jd.oWKj3j6juvO.hgRXD/4BemJBIIC4axq','0');
...
(4,4,3,1,48,9.00,8.0,384.00,'2023-08-30','1','{\"Paquete 1\":\"8\",\"Paquete 2\":\"8\",\"Paquete 3\":\"8\",\"Paquete 4\":\"8\",\"Paquete 5\":\"8\",\"Paquete 6\":\"8\"}'),
(5,5,1,3,276,5.40,1.3,1460.50,'2023-09-01','1','{\"Paquete 1\":\"12\",\"Paquete 2\":\"12\",\"Paquete 3\":\"12\",\"Paquete 4\":\"12\",\"Paquete 5\":\"12\",\"Paquete 6\":\"12\",\"Paquete 7\":\"12\",\"Paquete 8\":\"12\",\"Paquete 9\":\"12\",\"Paquete 10\":\"12\",\"Paquete 11\":\"12\",\"Paquete 12\":\"12\",\"Paquete 13\":\"12\",\"Paquete 14\":\"12\",\"Paquete 15\":\"12\",\"Paquete 16\":\"12\",\"Paquete 17\":\"12\",\"Paquete 18\":\"12\",\"Paquete 19\":\"12\",\"Paquete 20\":\"12\",\"Paquete 21\":\"12\",\"Paquete 22\":\"12\",\"Paquete 23\":\"12\"}');
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_detalleinsumo_registrar`(IN _idformula INT,
IN _idinsumo INT,
...
/* Procedure structure for procedure `spu_listar_insumos_por_formula` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_insumos_por_formula` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_insumos_por_formula`(IN _idformula INT)
BEGIN
...
/* Procedure structure for procedure `sp_filtro_fech` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_fech` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_fech`(
...
/* Procedure structure for procedure `sp_filtro_insumo` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_insumo` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_insumo`(IN p_idinsumo INT)
BEGIN
  SELECT
	de.fecha_entrada,
	de.detalle,
...
/* Procedure structure for procedure `sp_filtro_insumofechid` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_insumofechid` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_insumofechid`(
    IN p_idinsumo INT,
    IN p_fecha_inicio DATE,
    IN p_fecha_fin DATE
)
...
/* Procedure structure for procedure `sp_filtro_salidafecha` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_salidafecha` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_salidafecha`(
...
/* Procedure structure for procedure `sp_filtro_salidafechid` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_salidafechid` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_salidafechid`(
    IN _idinsumo INT,
    IN _fecha_inicio DATE,
    IN _fecha_fin DATE
)
...
/* Procedure structure for procedure `sp_filtro_salidaidinsumo` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtro_salidaidinsumo` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtro_salidaidinsumo`(
    IN _idinsumo INT
)
BEGIN
    SELECT
