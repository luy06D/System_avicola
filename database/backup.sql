...
(1,1,1,150.00,NULL,NULL,'2023-08-30'),
(2,1,2,150.00,NULL,NULL,'2023-08-30'),
(3,1,4,100.00,NULL,NULL,'2023-08-30'),
...
(1,'SOYA','KG',742,'Proteica, vegetal, versátil, nutricional','1'),
(2,'AFRECHO','KG',13000,'Fibroso, salvado, integral, nutritivo.','1'),
(3,'MAIZ','KG',5198,'Cereal, amarillo, versátil, nutritivo.','1'),
(4,'SAL','KG',1555,'Mineral, condimento, saborizante, conservante','1'),
(5,'ACHOTE','KG',6150,'','1'),
(6,'METHIONINE','KG',0,'','1'),
(7,'COLINA','KG',7000,'','1'),
