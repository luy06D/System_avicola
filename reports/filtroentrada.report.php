...
try {
    ...
    if(!empty($idinsumo)){
        $data = $reporte->filtroinsumo($idinsumo);
    

    }elseif (!empty($fechainicio) && !empty($fechafin)){
        $data = $reporte->filtroinsumofechas($fechainicio, $fechafin);

    }elseif(!empty($fechainicio) && !empty($fechafin) && !empty($idinsumo)){
        $data = $reporte->filtroinsumoid($fechainicio, $fechafin , $idinsumo);
    }
    ...
    include './filtroentrada.data.php';
