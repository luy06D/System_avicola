        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                Almacén
                    ...
                    <li><a class="dropdown-item" href="./insumos.php"><h5><i class="bi bi-bar-chart"></i> Insumos</a></h5></li>
                    <li><a class="dropdown-item" href="./formulas.php"><h5><i class="bi bi-truck"></i> Formulas</h5></a></li> 
                        ...
                        <div class="row">
                            ...
                            <div class=" col-lg-3">
                                <div class="input-group  mt-4">
                                    ...
                                    <button id="registrarFormula" class="btn btn-success" type="button">Agregar</button>
                                </div> 
                            ...
                            <div class="col-md-3 mt-4">
                                <div class="">
                                    <button id="" class="btn btn-warning btn-md " type="button" data-bs-toggle="modal" data-bs-target="#modal-addInsumo">Agregar insumo</button>                    
                                </div>
                            </div>                     
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                if(formula === ''){
                    ...
                    parameter.append("unidad", document.querySelector("#unidad").value);
